...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] animate-in fade-in-30 zoom-in-80 duration-500">
      <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 duration-300 text-center max-w-md w-full">
        ...
        <Link
          href="/"
          className="w-full group inline-flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white font-medium py-4 px-6 rounded-xl transition-all transform active:scale-[0.99]"
        >
